...
class Form extends Component {
  ...
  handleAdd() {
    ...
    this.displayResult(parseInt(firstNumber, 0) + parseInt(secondNumber, 0));
  }
    ...
    return (
      <form className="form-group">
        <fieldset className="form-group">
          <label className="form-label">1st Number:</label>
          <input
            type="text"
            id="number1"
        ...
        <fieldset className="form-group">
          <label className="form-label">2nd Number:</label>
          <input
            type="text"
            id="number2"
            className="form-input"
